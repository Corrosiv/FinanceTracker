        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimitAmount = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DeduplicationHash = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Imports_UserId_UploadDate",
                table: "Imports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UserId_Date_Amount_NormalizedDescription",
                table: "Transactions",
                columns: new[] { "UserId", "Date", "Amount", "NormalizedDescription" },
                unique: true);
